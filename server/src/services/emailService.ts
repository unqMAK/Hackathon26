...
class EmailService {
    ...
    async sendCredentialEmail(to: string, name: string, role: string, password?: string, isExisting: boolean = false) {
        try {
            ...
            let subject = 'SAMVED Hackathon Governance Portal - Account Update';
            let mainContent = '';
            ...
            if (isExisting) {
                ...
                mainContent = `
                    <p>Welcome to <strong>MIT Vishwaprayag University SAMVED Hackathon</strong>.</p>
            ...
            const info = await this.transporter.sendMail({
                from: `"MIT-VPU SAMVED Hackathon" <${process.env.SMTP_USER}>`,
                to,
                subject,
                html: htmlContent,
                attachments: [{
    ...
    async sendWelcomeEmail(to: string, name: string, teamName: string) {
        try {
            const logoPath = path.join(__dirname, '../../public/uploads/mit-vpu-logo.png');
            const subject = `Welcome to SAMVED Hackathon - Team ${teamName} Approved!`;
                ...
                <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f9fafb; color: #1f2937;">
                    <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); overflow: hidden;">
                        ...
                        <div style="padding: 40px;">
                            ...
                            <div style="font-size: 16px; line-height: 1.6; color: #4b5563;">
                                <p>We are thrilled to inform you that your team <strong>"${teamName}"</strong> has been officially approved for <strong>MIT Vishwaprayag University SAMVED Hackathon</strong>!</p>
    ...
    async sendRejectionEmail(to: string, name: string, teamName: string, reason: string) {
        try {
            const logoPath = path.join(__dirname, '../../public/uploads/mit-vpu-logo.png');
            const subject = `Team Registration Update - ${teamName}`;
                ...
                <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f9fafb; color: #1f2937;">
                    <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); overflow: hidden;">
                        ...
                        <div style="padding: 40px;">
                            <h2 style="color: #111827; margin-top: 0; font-size: 24px; font-weight: 600;">Hello, ${name}</h2>
                            <div style="font-size: 16px; line-height: 1.6; color: #4b5563;">
                                <p>We regret to inform you that your team <strong>"${teamName}"</strong> registration for <strong>MIT Vishwaprayag University SAMVED Hackathon</strong> could not be approved at this time.</p>
                                <div style="background-color: #fef2f2; padding: 20px; border-radius: 8px; border: 1px solid #fecaca; margin: 25px 0;">
                                    ...
                                    <p style="margin: 10px 0 0; color: #7f1d1d;">${reason || 'No specific reason provided. Please contact the administrator for more details.'}</p>
                                </div>
                                <p>If you believe this was an error or have questions, please reach out to our support team.</p>
                            </div>
                            <div style="text-align: center; margin-top: 35px;">
                                <a href="mailto:hackathon@mitvpu.ac.in" style="display: inline-block; background-color: #D97706; color: white; padding: 14px 32px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px; transition: background-color 0.2s;">Contact Support</a>
                            </div>
                        </div>
                        <div style="background-color: #f3f4f6; padding: 20px; text-align: center; border-top: 1px solid #e5e7eb;">
                            <p style="margin: 0; font-size: 12px; color: #9ca3af;">&copy; ${new Date().getFullYear()} MIT Vishwaprayag University. All rights reserved.</p>
                ...
                <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f9fafb; color: #1f2937;">
                    <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); overflow: hidden;">
                        ...
                        <div style="padding: 40px;">
                            <h2 style="color: #111827; margin-top: 0; font-size: 24px; font-weight: 600;">Hello, ${name}!</h2>
                            <div style="font-size: 16px; line-height: 1.6; color: #4b5563;">
                                <p>Thank you for registering your team <strong>"${teamName}"</strong> for <strong>MIT Vishwaprayag University SAMVED Hackathon</strong>!</p>
                                <div style="background-color: #fef3c7; padding: 20px; border-radius: 8px; border: 1px solid #fcd34d; margin: 25px 0;">
                                    <p style="margin: 0; color: #92400e; font-weight: 600;">Registration Status: Pending Review</p>
                                    <p style="margin: 10px 0 0; color: #78350f;">Your registration is being reviewed by our team. You will receive an email once your team is approved.</p>
                                </div>
                                <p>In the meantime, please ensure all your team details and documents are correct. If you need to make any changes, please contact our support team.</p>
                            </div>
                        </div>
                        <div style="background-color: #f3f4f6; padding: 20px; text-align: center; border-top: 1px solid #e5e7eb;">
                            <p style="margin: 0; font-size: 12px; color: #9ca3af;">&copy; ${new Date().getFullYear()} MIT Vishwaprayag University. All rights reserved.</p>
    ...
    async sendPasswordResetEmail(to: string, name: string, newPassword: string): Promise<boolean> {
        try {
            const logoPath = path.join(__dirname, '../../public/uploads/mit-vpu-logo.png');
            const subject = `Password Reset - SAMVED Hackathon`;
                ...
                <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f9fafb; color: #1f2937;">
                    <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); overflow: hidden;">
                        ...
                        <div style="padding: 40px;">
                            <h2 style="color: #111827; margin-top: 0; font-size: 24px; font-weight: 600;">Hello, ${name}!</h2>
                            <div style="font-size: 16px; line-height: 1.6; color: #4b5563;">
                                <p>Your password reset request for <strong>MIT Vishwaprayag University SAMVED Hackathon</strong> portal has been approved.</p>
                                <div style="background-color: #ecfdf5; padding: 20px; border-radius: 8px; border: 1px solid #d1fae5; margin: 25px 0;">
                                    <p style="margin: 0; color: #065f46; font-weight: 600;">Your New Password:</p>
                                    <p style="margin: 10px 0 0; font-family: monospace; background: #fff; padding: 12px 16px; border-radius: 6px; border: 1px solid #d1fae5; color: #047857; font-size: 18px; font-weight: bold; letter-spacing: 1px;">${newPassword}</p>
                                </div>

                                <p>If you did not request this password reset, please contact our support team immediately.</p>
                            </div>
                            <div style="text-align: center; margin-top: 35px;">
                                <a href="${process.env.CLIENT_URL || 'http://localhost:5173'}/login" style="display: inline-block; background-color: #D97706; color: white; padding: 14px 32px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px; transition: background-color 0.2s;">Login Now</a>
                            </div>
                        </div>
                        <div style="background-color: #f3f4f6; padding: 20px; text-align: center; border-top: 1px solid #e5e7eb;">
                            <p style="margin: 0; font-size: 12px; color: #9ca3af;">&copy; ${new Date().getFullYear()} MIT Vishwaprayag University. All rights reserved.</p>
