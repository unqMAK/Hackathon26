        ...
        const emailHtml = `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <p style="text-align: center; color: #6c757d; font-size: 12px; margin-top: 20px;">
                    This message was sent from the HackSphere Contact Form
                </p>
            </div>
        `;

        await transporter.sendMail({
            from: `"HackSphere Contact" <${process.env.SMTP_USER}>`,
            to: adminEmail,
            subject: `[HackSphere Contact] ${subject}`,
            html: emailHtml
        });
            ...
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <div style="background: #f8f9fa; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #e9ecef;">
                    ...
                    <ul style="color: #495057; list-style: none; padding: 0;">
                        ...
                        <li style="padding: 5px 0;">📞 Phone: +91 2137 305000</li>
                    </ul>
                    <p style="color: #495057;">Best regards,<br><strong style="color: #0052CC;">HackSphere Team</strong></p>
                </div>
            </div>
        `;

        await transporter.sendMail({
            from: `"HackSphere Team" <${process.env.SMTP_USER}>`,
            to: email,
            subject: 'Thank you for contacting HackSphere!',
