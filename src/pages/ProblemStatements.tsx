              ...
              >
                ...
                <TableCell className="py-4">
                  <div className="flex flex-col gap-1">
                    <span className="bg-gradient-to-r from-[#8B2A3B] to-[#E25A2C] text-white px-3 py-1 rounded-full text-xs font-bold inline-block w-fit">
                      Software / Hardware
                    </span>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Stats Card - Total Problems */}
        <div className="flex justify-center mb-12">
          <Card className="bg-gradient-to-r from-[#8B2A3B] via-[#a53549] to-[#E25A2C] text-white border-none hover:scale-105 hover:shadow-2xl transition-all duration-300 shadow-lg p-8 flex flex-col items-center justify-center animate-slide-up relative overflow-hidden min-w-[300px]" style={{ animationDelay: '0.1s' }}>
